...
for chrom_num in $(seq 1 22); do 
	...
	variant_level_annotation_file=${preprocessed_tgfm_sldsc_data_dir}baselineLD_no_qtl.${chrom_num}.annot
	gene_level_sldsc_output_root=${preprocessed_tgfm_sldsc_data_dir}tissue_eqtl.${chrom_num}.
	python3 create_gene_level_ld_scores.py $variant_level_annotation_file $variant_level_ld_score_file ${ref_1kg_genotype_dir}1000G.EUR.hg38.${chrom_num} $pseudotissue_name $gtex_susie_gene_models_dir $chrom_num $gene_type $gene_level_sldsc_output_root
done
